...
$src="http://moyalmetevsk.ru"; $file="_index-indexpage";
    ...
    $longBannerData = [
        ...
        'items' => [
            [
                ...
                'image' => 'http://prokazan.ru/template/advert/1.jpg',
            ],
            [
    ...
    foreach ( $list as $ar ) {
		...
		<div class="news-short">
			<div class="news-short__time">{$date}</div>
				<a class="news-short__header" href="{$link}" {$rel} title="{$ar['name']}">{$ar['name']}</a>
		</div>
HTML;
