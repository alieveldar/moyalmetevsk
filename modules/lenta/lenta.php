    ...
    if($data["total"] == 1) {
        ...
        if($new["alttext"] == "") {
            ...
            if($new["promo"] != 1) {
                ...
                // $text .= '<div id="unit_92471"><a href="http://smi2.ru/" >Новости СМИ2</a></div><script type="text/javascript" charset="utf-8">(function() {var sc = document.createElement(\'script\'); sc.type = \'text/javascript\'; sc.async = true;sc.src = \'//smi2.ru/data/js/92471.js\'; sc.charset = \'utf-8\';var s = document.getElementsByTagName(\'script\')[0]; s.parentNode.insertBefore(sc, s);}());</script>';
            }
...
(function(w, d, n, s, t) {
    ...
    if( empty($item["uid"]) || empty($item["nick"]) ) {
        ...
        $noauthor = '<span class="article-info__author">Автор: moyalmetevsk.ru</span>';
    } else {
...
HTML;
	...
	$yandex.= '<!-- Yandex.RTB R-A-327026-2 -->
<div id="yandex_rtb_R-A-327026-2"></div>
<script type="text/javascript">
    (function(w, d, n, s, t) {
        w[n] = w[n] || [];
        w[n].push(function() {
            Ya.Context.AdvManager.render({
                blockId: "R-A-327026-2",
                renderTo: "yandex_rtb_R-A-327026-2",
                async: true
            });
        });
        t = d.getElementsByTagName("script")[0];
...
$yandex1.= '<!-- Yandex.RTB R-A-327026-1 -->
<div id="yandex_rtb_R-A-327026-1"></div>
<script type="text/javascript">
    (function(w, d, n, s, t) {
        w[n] = w[n] || [];
        w[n].push(function() {
            Ya.Context.AdvManager.render({
                blockId: "R-A-327026-1",
                renderTo: "yandex_rtb_R-A-327026-1",
                async: true
            });
        });
        t = d.getElementsByTagName("script")[0];
...
HTML;
    ...
    ### компановка на вывод
    $text = '<article class="article" id="article" data-id="' . $item['id'] . '">' . $heading . $lid . '<hr class="article__line">' . "<div class='ArticleContent js-mediator-article'>" .$yandex1. $maintext . "</div>" . $report . $cards . $video . $yandex.$endtext . $voting . $album . $event . $QA . $contactsHTML . $realinfo . $yandex . $mixblock . $share . $social . $readmore . $ban . '</article>';
